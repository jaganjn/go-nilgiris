...
const places = [
  {
    ...
    icon: "🏨",
    description:
      "An 8-acre hilltop resort with family rooms, restaurants, a spa, indoor and outdoor activities, valley views and easy access to Ooty attractions.",
  },
  {
  ...
  },
  {
    ...
    icon: "🍽️",
    description:
      "A heritage fine-dining restaurant inside King's Cliff, known for its glass atrium, colonial ambience and popular continental dishes.",
  },
  {
    ...
    icon: "🚕",
    description:
      "A 24-hour cab and tour service for Nilgiris sightseeing, outstation trips, one-way travel and airport or railway transfers.",
  },
  {
  ...
  },
  {
    ...
    icon: "🛍️",
    description:
      "A popular local shopping market for winter clothing, woollens, Tibetan handicrafts, accessories and Nilgiris souvenirs.",
  },
];
      ...
      <section className="px-5 py-10">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-8 flex flex-col justify-between gap-3 sm:flex-row sm:items-end">
            ...
            <p className="text-sm text-slate-500">Showing {places.length} listings</p>
          </div>
            ...
            {places.map((place) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="mt-4 leading-7 text-slate-600">{place.description}</p>
                  <div className="mt-6">
                    <Link
